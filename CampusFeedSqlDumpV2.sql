...
--
-- Temporary view structure for view `driverratingsview`
--

DROP TABLE IF EXISTS `driverratingsview`;
/*!50001 DROP VIEW IF EXISTS `driverratingsview`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `driverratingsview` AS SELECT 
 1 AS `Food_Handling`,
 1 AS `Average_Rating`,
 1 AS `Average_Time`*/;
...
--
-- Temporary view structure for view `restaurantratingsview`
--

DROP TABLE IF EXISTS `restaurantratingsview`;
/*!50001 DROP VIEW IF EXISTS `restaurantratingsview`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `restaurantratingsview` AS SELECT 
 1 AS `Food_Rating`,
 1 AS `Average_OrderRating`,
 1 AS `Average_Accuracy`,
 1 AS `Overall_Rating`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `driverratingsview`
--
...
/*!50001 VIEW `driverratingsview` AS select `driver_rating`.`Food_Handling` AS `Food_Handling`,avg(`driver_rating`.`Overall_Rating`) AS `Average_Rating`,avg(`driver_rating`.`Time`) AS `Average_Time` from `driver_rating` where (`driver_rating`.`Time` >= 20) group by `driver_rating`.`Food_Handling` order by `driver_rating`.`Food_Handling` */;
...
--
-- Final view structure for view `restaurantratingsview`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restaurantratingsview` AS select `restaurant_rating`.`Food_Rating` AS `Food_Rating`,avg(`restaurant_rating`.`Overall_Rating`) AS `Average_OrderRating`,avg(`restaurant_rating`.`Order_Accuracy`) AS `Average_Accuracy`,(avg(((`restaurant_rating`.`Overall_Rating` + `restaurant_rating`.`Order_Accuracy`) + `restaurant_rating`.`Food_Rating`)) / 3) AS `Overall_Rating` from `restaurant_rating` group by `restaurant_rating`.`Food_Rating` order by `restaurant_rating`.`Food_Rating` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-12-15 18:07:03
